...
__global__ void emul_kernel(float *a_ptr, float *b_ptr, float *d_ptr, int n) {
...
extern "C" float *emul_f32(float *a_ptr, float *b_ptr, float *d_ptr, int n) {
  ...
  emul_kernel<<<blocks, threads>>>(a_ptr, b_ptr, d_ptr, n);
